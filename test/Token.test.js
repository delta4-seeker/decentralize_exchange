...
contract('Token' ,  ([deployer, receiver ]) => {
  ...
  describe('sending tokens ' , () => {
    ...
    describe('success' , () => {
      beforeEach( async () => {
        result = await  token.transfer(receiver , "100000000000000" , { from : deployer})
       })
       it('transfer token to receipient' ,async () => {
         ...
         balanceOf.toString().should.equal((parseInt(totalSupply) - parseInt("100000000000000")).toString());
